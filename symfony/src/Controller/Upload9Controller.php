...
class Upload9Controller extends AbstractController
{
    ...
    #[Route('/api/upload9', name: 'upload9', methods: ['GET', 'POST'])]
...
if ($accountSize->getSize((string)$data,(int)0)['limityPrzekroczone']['size']===1 || (int)$CategoryId>(int)250 || (int)$CategoryId<(int)0){
...
$tab=array('user'=>$user,'category'=>$CategoryId,'product'=>0);
