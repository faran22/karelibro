...
use App\Repository\Szablon2Repository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=Szablon2Repository::class)
 */
#[ApiResource(
#routePrefix: '/library',
...
class Szablon2
{
     ...
     */
    #[Groups(groups: ['category1:collection:post'])]
     ...
     * @ORM\Column(type="integer")
     */
    #[Groups(groups: ['category1:collection:post','category1:collection:get','category1:item:put'])]
